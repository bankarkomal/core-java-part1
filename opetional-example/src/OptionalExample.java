...
What is optional class in java?
 A container object  which may or may not contain non value.
 If value is present or Is-present() return true.
 The no value is,present the object is considered empty and is-present() return false.
 Additional method  that depends on presence or absence  of contained value are provided.
